...
<h1>Consultar Datos con Join </h1>
</div>
...
<div class="content flex">
        ...
        <table style="position: absolute; left: 500px; ">
              <form method="post" action="ConsultartablaC.php" enctype="multipart/form-data"> 
                  <tr>
                 ...
                 <!--  <tr>
                      <td class="espacio" name="idcompetidor" >idcompetidor</td>
                      <td class="espacio" name="Nombre"  value="Nombre">Nombre</td>
                      <td class="espacio" name="primerapellido"  value="Primer Apellido">Primer Apellido</td>
                      <td class="espacio" name="Edad" >Edad</td>
                      <td class="espacio" name="DNI" >DNI</td>
                      <td class="espacio" name="idubicacion " >idubicacion</td>
                      <td class="espacio" name="idcategoria" >idcategoria</td>
                       Lo de arriba tabla competidores
                      <td class="espacio" name=" Pais" >Pais</td>
                      <td class="espacio" name=" Provincia" >Provincia</td>
                      <td class="espacio" name="Fecha" >Fecha</td>
                      <td class="espacio" name="nombre_categoria">Nombre Categoria</td>
                  </tr>

                  <tr>
                        <td class="espacio"><input type="checkbox"id="idcomp" name="idcomp" value="idcompetidor"></td>
                        <td class="espacio"><input type="checkbox" id="nombre" name="nombre" value="Nombre"></td>
                        <td class="espacio"><input type="checkbox" id="primerapellido" name="primerapellido" value="Primer Apellido"></td>
                        <td class="espacio"><input type="checkbox" id="edad" name="edad" value="Edad"></td>
                        <td class="espacio"><input type="checkbox" id="dni" name="dni" value="DNI"></td>
                        <td class="espacio"><input type="checkbox" id="idubi" name="idubi" value="idubicacion"></td>
                        <td class="espacio"><input type="checkbox" id="idcateg" name="idcateg" value="idcategoria"></td>
                         Lo de arriba tabla competidores 
                        <td class="espacio"><input type="checkbox" id="pais" name="pais" value="Pais"></td>
                        <td class="espacio"><input type="checkbox" id="provincia" name="provincia" value="Provincia"></td>
                        <td class="espacio"><input type="checkbox" id="fecha" name="fecha" value="Fecha"></td>
                        <td class="espacio"><input type="checkbox" id="nombrecategoria" name="nombrecategoria"  value="Nombre Categoria"></td>
                  </tr>
                  <tr>
                    
                    <td><input type="submit" value="Consultar Columnas" class="btn btn-primary btn-block"></td>
                  </tr> -->
