...
<!--Content starts RECUERDA TODO LA INFORMACION QUE HAGAS AQUIIIIIIIIIIIIII-->
          ...
          <div class="content flex">
            ...
            <!-- Lo de arriba es el menu -->


            <div class="container">
        <h2>Insertar Competidor/ra</h2>
        <form method="post" action="enviar.php">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="edad" id="edad">
            </div>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $sql = "SELECT idcategoria, nombre_categoria FROM categorias";
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $sql = "SELECT provincia , idubicacion FROM ubicacion_competicion";

                    $registros = mysqli_query($conexion, $sql) 
                            or die("Problemas en select:".mysqli_error($conexion));

                    while($reg=mysqli_fetch_array($registros)) {
                        echo "<option value='$reg[idubicacion]'> $reg[provincia] </option>";
                    }
               ?>
                </select>
                <br/>
